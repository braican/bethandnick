import { getOtherGuestMarkup } from './guestResponseUtils';

export const createDeclinedEmail = (activeGuest, otherGuests = []) => {
                          ...
                          <tr>
                            <td align="left">
                              <h1 style="font-family: Roboto, Helvetica, Arial, sans-serif;">
                                Oh no! We're sorry you can't make it.
                              </h1>
                            </td>
                          </tr>
                          <tr>
                            <td align="left" style="font-size: 22px; line-height: 34px; font-family: Roboto, Helvetica, Arial, sans-serif; color: #333333; background-color: #fff;" bgcolor="#fff">
                              We understand, things can get busy. While we're disappointed we won't get to celebrate with you in December, we hope to see you real soon.
                            </td>
                          </tr>
                          <tr>
                            <td height="20"></td>
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      <td class="padding" align="center">
                        <img
                          src="https://api.bethandnick.us/img/prom-photo.jpg"
                          width="660"
                          height="660"
                          border="0"
                          alt="Nick and Beth and their first prom"
                          style="display: block;"
